namespace SharpNeat
{
	partial class ProgressForm
	{
		...
		private void InitializeComponent()
		{
            ...
            this.genomeLengthGraph = new ZedGraph.ZedGraphControl();
            ...
            this.splitContainer4.Panel2.Controls.Add(this.genomeLengthGraph);
            ...
            // genomeLengthGraph
            // 
            this.genomeLengthGraph.Dock = System.Windows.Forms.DockStyle.Fill;
            this.genomeLengthGraph.IsAutoScrollRange = false;
            this.genomeLengthGraph.IsEnableHPan = true;
            this.genomeLengthGraph.IsEnableHZoom = true;
            this.genomeLengthGraph.IsEnableVPan = true;
            this.genomeLengthGraph.IsEnableVZoom = true;
            this.genomeLengthGraph.IsPrintFillPage = true;
            this.genomeLengthGraph.IsPrintKeepAspectRatio = true;
            this.genomeLengthGraph.IsScrollY2 = false;
            this.genomeLengthGraph.IsShowContextMenu = true;
            this.genomeLengthGraph.IsShowCopyMessage = true;
            this.genomeLengthGraph.IsShowCursorValues = false;
            this.genomeLengthGraph.IsShowHScrollBar = false;
            this.genomeLengthGraph.IsShowPointValues = false;
            this.genomeLengthGraph.IsShowVScrollBar = false;
            this.genomeLengthGraph.IsZoomOnMouseCenter = false;
            this.genomeLengthGraph.Location = new System.Drawing.Point(0, 0);
            this.genomeLengthGraph.Name = "evalsPerSecGraph";
            this.genomeLengthGraph.PanButtons = System.Windows.Forms.MouseButtons.Left;
            this.genomeLengthGraph.PanButtons2 = System.Windows.Forms.MouseButtons.Middle;
            this.genomeLengthGraph.PanModifierKeys2 = System.Windows.Forms.Keys.None;
            this.genomeLengthGraph.PointDateFormat = "g";
            this.genomeLengthGraph.PointValueFormat = "G";
            this.genomeLengthGraph.ScrollMaxX = 0;
            this.genomeLengthGraph.ScrollMaxY = 0;
            this.genomeLengthGraph.ScrollMaxY2 = 0;
            this.genomeLengthGraph.ScrollMinX = 0;
            this.genomeLengthGraph.ScrollMinY = 0;
            this.genomeLengthGraph.ScrollMinY2 = 0;
            this.genomeLengthGraph.Size = new System.Drawing.Size(270, 118);
            this.genomeLengthGraph.TabIndex = 0;
            this.genomeLengthGraph.ZoomButtons = System.Windows.Forms.MouseButtons.Left;
            this.genomeLengthGraph.ZoomButtons2 = System.Windows.Forms.MouseButtons.None;
            this.genomeLengthGraph.ZoomModifierKeys = System.Windows.Forms.Keys.None;
            this.genomeLengthGraph.ZoomModifierKeys2 = System.Windows.Forms.Keys.None;
            this.genomeLengthGraph.ZoomStepFraction = 0.1;
            // 
            // splitContainer3
            // 
        ...
        private ZedGraph.ZedGraphControl genomeLengthGraph;
