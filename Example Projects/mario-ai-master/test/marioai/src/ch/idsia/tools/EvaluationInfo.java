...
//    public int totalNumberOfCoins = MagicNumberUndef;
    ...
    public int totalJumpsPerformed = MagicNumberUndef;
    ...
    public int mushroomsTotal = MagicNumberUndef;
    public int flowersTotal = MagicNumberUndef;
    public int blocksHit = MagicNumberUndef;
    ...
    public int computeTotalPowerups()
    {
        return this.mushroomsTotal + this.flowersTotal;
    }
...
//        ret += "\nCoins Gained: " + numberOfGainedCoins/totalNumberOfCoins*100 + "%. (" + numberOfGainedCoins + " of " + totalNumberOfCoins + ")";
        ...
        ret += "\n                   Mushrooms Gained : " + mushroomsTotal;
        ret += "\n                     Flowers Gained : " + flowersTotal;
        ret += "\n                         Blocks Hit : " + blocksHit;
