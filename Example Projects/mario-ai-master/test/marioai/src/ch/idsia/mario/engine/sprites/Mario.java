...
//    public static String levelString = "none";
    ...
    public static List<Point> bumpedBricks;
    ...
    public static void resetStatic(int marioMode)
    {
        ...
        blocksHit = 0;
        totalJumps = 0;
        bumpedBricks = new ArrayList<Point>();
...
//        ++numberOfAttempts;
    ...
    public static final int STATUS_SUICIDE = 3;
...
//            }
        ...
        {
            die(true);             // JAT - fall into pit death!
        }
    ...
    public void die(boolean suicide)
    {
        xDeathPos = (int) x;
        yDeathPos = (int) y;
        world.paused = true;
        deathTime = 25;
        status = suicide ? Mario.STATUS_SUICIDE : Mario.STATUS_DEAD;
    }
...
//        if (deathTime > 0 || world.paused) return;
    ...
    {
        return instance.mayJump;
    }

    public static boolean canShoot()
    {
        return fire && instance.canShoot; 
    }

    public static void bumpBrick(int x, int y)
    {
        bumpedBricks.add(new Point(x, y));
    }
    ...
    public static boolean hitBlock(int x, int y)
    {
        Point p = new Point(x,y);
        if(!bumpedBricks.contains(p))
        {
            bumpedBricks.add(p);
            blocksHit++;
            return true;
